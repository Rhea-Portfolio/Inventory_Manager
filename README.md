...
# Commands
podman compose up (-d, with -d, podman compose runs in background)
podman compose build (rebuild the container images, necessary when there are changes in for example requirements.txt)